...
public class ReportController {
    ...
    public ResponseEntity<GeneralResponse> createReportAsync(@RequestBody ReportRequest request) {
    ...
    public ResponseEntity<GeneralResponse> deleteFile(@PathVariable("reqId") String reqId){
