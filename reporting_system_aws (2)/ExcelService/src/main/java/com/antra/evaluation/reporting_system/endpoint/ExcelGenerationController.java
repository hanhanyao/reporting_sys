...
public class ExcelGenerationController {
    ...
    public
    ResponseEntity<ExcelResponse> createExcel(@RequestBody @Validated ExcelRequest request) {
    ...
    public ResponseEntity<List<ExcelResponse>> listExcels() {
        ...
        var responseList = fileList.stream().map(file -> {
            ...
            response.getGeneratedTime(file.getGeneratedTime());
            response.setReqId(file.getReqId());
            response.setFileDownloadLink(file.getFileLocation());
    ...
    public ResponseEntity<ExcelResponse> deleteExcel(@PathVariable String id) throws FileNotFoundException {
        ...
        response.setReqId(fileDeleted.getReqId());
